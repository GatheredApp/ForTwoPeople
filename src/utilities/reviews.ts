...
export function createReviewIssueUrl(payload: NonNullable<ReturnType<typeof reviewPayload>>) {
  ...
  const listingNote = payload.buffetId
    ...
    : 'This buffet is not currently linked to the map. Review approval publishes the review on the Community Reviews page; it does not create a map marker. Use the separate Suggest a Buffet form to propose a map listing.'
